...
function FinalRepot1(props) {
  ...
  const downloadPdf = () => {
    ...
    const options = {
      margin: [35, 25, 25, 25], // top, left, bottom, right (mm)
        ...
        <div ref={pdfRef} className="pdf-container">
          ...
          <div className="page-break" style={{ marginTop: "20px" }}>
            ...
            <div className="brkAvoid page-break">
              {" "}
              <p className="font12Print page-start">
                            ...
                            >
                              ...
                              <TableCell sx={{
                              ...
                              }}>
                                {
                                  ...
                                  >
                                    <span>{row1[5] && row1[5].answer}</span>
                                  </div>
                                }
                              </TableCell>
                              ...
                              <TableCell sx={{
                              ...
                              }}>
                                {
                                  ...
                                  >
                                    <span>{row1[4] && row1[4].answer}</span>
                                  </div>
                                }
                              </TableCell>
