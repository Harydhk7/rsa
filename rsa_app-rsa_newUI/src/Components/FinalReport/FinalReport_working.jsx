...
function FinalReport() {
  ...
  const generatePDFSave = useReactToPrint({
    content: () => pdfRef.current,
    copyStyles: true,
    onPrintError: (error, c) => console.log(c, error),
    print: async (printIframe) => {
      ...
      if (document) {
        ...
        await new Html2Pdf().set(options).from(html).outputPdf('blob').then((pdfObj) => {
        ...
        //await new Html2Pdf().from(html).toPdf().save()
        await new Html2Pdf().from(html).toPdf().output('datauristring').
          then(function (pdfAsString) {
            // The PDF has been converted to a Data URI string and passed to this function.
            // Use pdfAsString however you like (send as email, etc)! For instance:
  ...
  const loadAnsImages = () => {
    ...
    //somehow settimeout makes the imageSource1 empty and images were not loading.
    ...
    {Object.keys(contentReport).length > 0 && (
      <div id="rsa_report_id" style={{ padding: "20px" }}>
        ...
        <div ref={pdfRef} className="pdf-container" >
          ...
          {/* pager two */}
          <div className="brkAlways"
            style={{
              marginTop: "100px", pageBreakAfter: "always"
            }}>
            <div
              style={{
                display: "flex",
          ...
          {/* page three */}
          <div className="brkAlways" style={{ marginTop: "20px", pageBreakAfter: "always" }}>
            <p className="font12Print"
              style={{
                // lineHeight: "28px",
              }}
          ...
          <div className="brkAlways" style={{ marginTop: "20px", pageBreakAfter: "always" }}>
            ...
            <p className="brkAlways brkAvoid"
              style={{
                marginTop: "20px",
                fontSize: "15px",
                fontWeight: "400",
            ...
            <TableContainer className="brkAvoid" style={{ marginTop: "25px", pageBreakInside: 'avoid' }} component={Paper}>
              <Table size="small">
                <TableHead>
            ...
            <div className="brkAlways" style={{ pageBreakInside: 'avoid' }}>
              <p className="font12Print brkAvoid"
                style={{
                  // lineHeight: "28px",
                  marginTop: "30px", pageBreakInside: 'avoid'
                }}
              >
                1.1.  Project Details
              </p>
            ...
            <div className="brkAlways"
              ...
              <p
                style={{
                  textAlign: "center",
                  fontWeight: "500",
                  fontSize: "14px", marginTop: "10px", marginBottom: "10px",
                }}
              >
            ...
            <div className="brkAvoid brkAlways"
              style={{
              ...
              >
                {contentReport.background.acc_summary}
              </p>
              <TableContainer
                //   component={Paper}
            ...
            {criticalSection.length > 0 && <>
              <div className="brkAlways"
                style={{
                  ...
                  justifyContent: "center",
                  alignItems: "center",
                  height: "95vh", pageBreakAfter: "always"
                }}
              >
                <p
                  style={{
                ...
                >{console.log(criticalSection, 'criticalSection')}
                  {criticalSection && criticalSection.map((i1, j1) => (
                    <div
                      ...
                      <TableContainer className="brkAvoid"
                        //component={Paper} 
                        style={{ height: "auto", overflow: "hidden", width: "100%", pageBreakInside: 'avoid' }}
                      // sx={{
                      //   backgroundColor:
                      //     j1 % 2 === 0 ? "#db179aff" : "#1fd647ff",
                      // }}
                      >
                          ...
                          >
                            {i1.map((row1, index) => (
                              ...
                              >
                                ...
                                <TableCell style={{ width: "90px !important" }}>
                                  {
                                    <div
                                      style={{
                                        display: "flex",
                                    ...
                                    >
                                      <span>{row1[1] && row1[1].answer}</span>
                                      <span style={{ fontSize: '9px' }} >{row1[2] && row1[2].answer}</span>
                                      <span ><b>{row1[0] && row1[0].answer}</b></span>
                                    </div>
                                  }
                                </TableCell>
                                <TableCell>
            ...
            {generalSection.length > 0 && <>
              ...
              <div className="stretch_details_rsa hfaztabone landscape_section"
                style={{ marginTop: "20px", marginBottom: "20px" }}>
                ...
                {generalSection.map((i2, j1) => {
                  return (
                    <div className="landscape_section brkAvoid" 
                    style={{ marginTop: "20px", marginBottom: "20px" }}>
                      <br />
