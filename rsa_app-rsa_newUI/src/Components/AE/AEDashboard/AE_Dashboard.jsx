...
import ofxhCM02 from "../AEHeader/AEHeader.jsx";
import {
  FormControl,
  IconButton,
  InputAdornment,
...
import AEHeader from "../AEHeader/AEHeader.jsx";
var map = ""
// import { Marker } from "react-leaflet";

export default function AE_Dashboard() {
  ...
  const loadMap = (l1) => {
    ...
    } else if (roleType.toLocaleLowerCase() == "ae") {
      AxiosApp.post(url1 + "dashboard_map_ae", l1)
        .then((response) => {
          setIsload(false);
          let l1 = response.data;
          if (response.data.statusCode == "200") {
  ...
  const loadAuditLists = () => {
    let l1 = { "user_id": localStorage.getItem("rsaLogged") }
