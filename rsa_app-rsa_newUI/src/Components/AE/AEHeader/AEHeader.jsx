        ...
        {(
          ...
          >
            <div
              style={{
                backgroundColor:
                  location?.pathname == "/Ae_dashboard" &&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color:
            ...
            <div
              style={{
                backgroundColor:
                  (location?.pathname?.includes("/Ae_Audit") ||
                  location?.pathname?.includes("/Ae_dataAnalysis"))&&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color: "white",
                cursor: "pointer",
                fontWeight: 500,
                color: !(location?.pathname?.includes("/Ae_Audit") ||
                  location?.pathname?.includes("/Ae_dataAnalysis"))
                  ? "rgba(46, 75, 122, 1)"
                  : "white",
              }}
              onClick={() => navigate("/Ae_Audit")}
            >
            ...
            <div
              ...
              onClick={() => navigate("/Ae_meet")}
            >
              {!tabletView ? "Meeting" : <AssessmentIcon />}
            </div>
            <div
              style={{
                backgroundColor:
                  location?.pathname == "/Ae_report" &&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color: "white",
        ...
        {!(
          ...
          >
            <div
              style={{
                backgroundColor:
                  location?.pathname == "/Auditor_dashboard" &&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color:
              ...
              onClick={() => navigate("/Auditor_dashboard")}
            >
              {!tabletView ? "Dashboard" : <DashboardIcon />}
            </div>
            <div
              style={{
                backgroundColor:
                  location?.pathname?.includes("/Auditor_Audit") &&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color: "white",
                cursor: "pointer",
                fontWeight: 500,
                color: !location?.pathname?.includes("/Auditor_Audit")
                  ? "rgba(46, 75, 122, 1)"
                  : "white",
              }}
              onClick={() => navigate("/Auditor_Audit")}
            >
              {!tabletView ? "Audit" : <IoIosClipboard size={24} />}
            </div>
            {/* <div
              style={{
                backgroundColor:
                  location?.pathname == "/Auditor_data" &&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color: "white",
              ...
              onClick={() => navigate("/Auditor_data")}
            >
              {!tabletView ? "Data Analysis" : <AssessmentIcon />}
            </div> */}
            <div
              style={{
                backgroundColor:
                  location?.pathname == "/Auditor_report" &&
                  "rgba(46, 75, 122, 1)",
                padding: "7px",
                borderRadius: "10px",
                color: "white",
