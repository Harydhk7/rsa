...
function Reports() {
  ...
  const columns = [
    ...
    { field: 'audit_type_id', flex: 1, headerName: 'Audit type id', hideable: true },
    {
          ...
          >
            ...
            <Button
              ...
              onClick={() => navigate("/AE_FinalReport",
                { state: { aid: l3, atid: l4, hidePrint: true } })}>
              AE Report
            </Button>
          </div>
        );
        ...
        return (
          ...
          >
            <Button
              ...
              onClick={(e, c) => {
                handleAppRej(params.row.audit_id, "approve")
              }}
            >
              Approve
            </Button>
            <Button
              ...
              onClick={() => {
                handleAppRej(params.row.audit_id, "reject")
              }}
            >
              Reject
            </Button>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            navigate("/Auditor_data",{state:{aid:"Audit06595"
                              ,uid:localStorage.getItem("rsaLogged"),editMode:true}})
                          }}
                        >
                          <DescriptionIcon />
                          Edit Report
